...
- Project communication channels (email, chat)
- Public spaces when representing the project (conferences, social media)
...
**Email:** conduct@vosemovies.com *(replace with actual email)*
...
- **Email:** conduct@vosemovies.com
- **GitHub:** Open an issue with the `code-of-conduct` label

---

**Remember:** VoseMovies exists to help the community find movies. Let's keep interactions positive, respectful, and focused on that goal.
